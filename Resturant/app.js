const resultContainer = document.getElementById("itemsContainer");
...
mains.addEventListener("click", mainsItems);
desserts.addEventListener("click", dessertItems);
beverages.addEventListener("click", beverageItems);
search.addEventListener('input', menuSearch);
